    ...
    <article className="article">
      ...
      <div className="article-text-wrapper">
        <p>
          ...
          maxime, dolorem quo dolores tempore inventore dolorum est nulla omnis
          maiores reiciendis neque cupiditate error, voluptates pariatur unde
          non tempora quibusdam?
        </p>
        <p>
